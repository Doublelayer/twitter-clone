    ...
    return (
      <div class="social-btn-wrapper">
        <div class="social-btn">
          <div>
            <a href="https://github.com/ntkme" aria-label="Follow @ntkme on GitHub">
              Follow @doublelayer
            </a>
          </div>
          <div class="cover">
            ...
            <div class="edge"></div>
            <div class="outer">
              <svg class="twitter-logo" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                <path
                  fill="white"
